...
async function setupDatabase() {
    ...
    `);
        ...
        // Try to add a fulltext index for better content searching (MySQL 5.6+)
        // This is wrapped in a try/catch since not all MySQL versions support it
        try {
        ...
        // Check if topic_id column exists and add it if missing
        try {
