        ...
        login.addEventListener('submit', function (e) {
            ...
            signInWithEmailAndPassword(auth, email, password)
                .then((userCredentail) => {
                    ...
                    // Store user in session storage to ensure it's available immediately
                    ...
                    // Redirect to chatbot page with correct path
        ...
        facebookLoginButton.addEventListener('click', () => {
            ...
            signInWithPopup(auth, provider)
                .then((result) => {
                    ...
                    window.location.href = '/public/chatbot.html'; // Redirect after successful login
                })
                .catch((error) => {
                    alert('Error: ' + error.message);
                });
